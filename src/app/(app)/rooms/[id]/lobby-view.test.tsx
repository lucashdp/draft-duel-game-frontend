...
const room = {
  ...
  match: {
    ...
    homeTeam: { id: 'th', name: 'Flamengo', shortName: 'Flamengo', abbreviation: 'FLA', imageUrl: null, primaryColor: '#FF0000', secondaryColor: '#000000' },
    awayTeam: { id: 'ta', name: 'Palmeiras', shortName: 'Palmeiras', abbreviation: 'PAL', imageUrl: null, primaryColor: '#006633', secondaryColor: '#FFFFFF' },
  },
